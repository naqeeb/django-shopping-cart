...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserStoreProfile'
        db.create_table('user_store_profile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'profile', ['UserStoreProfile'])

        # Adding model 'UserAddress'
        db.create_table('user_address', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.UserProfile'])),
        ...
        db.send_create_signal(u'profile', ['UserAddress'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'UserStoreProfile'
        db.delete_table('user_store_profile')

        # Deleting model 'UserAddress'
        db.delete_table('user_address')
    ...
    models = {
        ...
        u'profile.useraddress': {
            'Meta': {'object_name': 'UserAddress', 'db_table': "'user_address'"},
        ...
        u'profile.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'store': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['core.Store']", 'through': u"orm['profile.UserStoreProfile']", 'symmetrical': 'False'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'})
        },
        u'profile.userstoreprofile': {
            'Meta': {'object_name': 'UserStoreProfile', 'db_table': "'user_store_profile'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
