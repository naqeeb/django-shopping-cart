...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('cart_item', 'total')

        # Deleting field 'Cart.total'
        db.delete_column('cart', 'total')
